...
#更新txt_to_html.sh
curl -s "https://raw.githubusercontent.com/rakersfu/gist/main/hf_txt_to_html.sh" -o "$APP_HOME/txt_to_html.sh" \
...
#更新del_log.sh
curl -s "https://raw.githubusercontent.com/rakersfu/gist/main/hf_del_log.sh" -o "$APP_HOME/del_log.sh" \
